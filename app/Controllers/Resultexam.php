...
class Resultexam extends ResourceController
{
    protected $modelName = ModelsResultexam::class;
    protected $format    = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/Resultexam/paging/{status}/{perpage}/{page}",
     *   summary="Resultexam",
     *   description="Resultexam",
     *   tags={"Resultexam"},
     *   @OA\Parameter(
     *         name="status",
     *         in="path",
     ...
     *      @OA\JsonContent(ref="#/components/schemas/Resultexam")
     *   ),
     *   @OA\Response(
     ...
     *     @OA\JsonContent(
     *      type="array",
     *       @OA\Items(ref="#/components/schemas/Resultexam")
     *     ),
     *   ),
     *   @OA\Response(
     *     response=400, description="Bad Request"
    ...
    /**
     * @OA\Get(
     *   path="/api/Resultexam/myExam/{start}/{end}",
     *   summary="Resultexam",
     *   description="Resultexam",
     *   tags={"Resultexam"},
     *   @OA\Parameter(
    ...
    /**
     * @OA\Get(
     *   path="/api/Resultexam/exam/{start}/{end}/{roomId}/{classId}/{status}",
     *   summary="Resultexam",
     *   description="Resultexam",
     *   tags={"Resultexam"},
     *   @OA\Parameter(
    ...
    public function exam($start = '1652500511', $end = '1652500511', $roomId, $classId, $status = 1)
    {
        $record = $this->model
            ...
            ->where('sb.id', 1)
            ->where('resultexams.semesterId ', 1)
            ->groupBy('s.id,e.subjectId')
            ->findAll();
     ...
     *      @OA\Schema(ref="#/components/schemas/Resultexam"),
     *     )
     *   ),
     *   @OA\Response(
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesResultexam();
