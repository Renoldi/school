...
class SubjectDepartement extends ResourceController
{
    protected $modelName = ModelsSubjectDepartement::class;
    protected $format  = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/SubjectDepartement/paging/{perpage}/{page}",
     *   summary="SubjectDepartement",
     *   description="SubjectDepartement",
     *   tags={"SubjectDepartement"},
     *   @OA\Parameter(
     *         name="perpage",
     *         in="path",
     *         required=true,
     ...
     *      @OA\JsonContent(ref="#/components/schemas/SubjectDepartement")
     *   ),
     *   @OA\Response(
     ...
     *   @OA\JsonContent(
     *   type="array",
     *    @OA\Items(ref="#/components/schemas/SubjectDepartement")
     *   ),
     *  ),
     *  @OA\Response(
     *   response=400, description="Bad Request"
    ...
    /**
     * @OA\Get(
     *  path="/api/SubjectDepartement/{id}",
     *  summary="SubjectDepartement",
     *  description="SubjectDepartement",
     *  tags={"SubjectDepartement"},
     *  @OA\Parameter(
     ...
     *   @OA\Schema(ref="#/components/schemas/SubjectDepartement"),
     *   )
     *  ),
     *  @OA\Response(
    ...
    /**
     * @OA\Post(
     *  path="/api/SubjectDepartement/fromFile",
     *  summary="SubjectDepartement",
     *  description="SubjectDepartement",
     *  tags={"SubjectDepartement"},
     *  @OA\RequestBody(
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesSubjectDepartement();
    ...
    /**
     * @OA\Post(
     *   path="/api/SubjectDepartement/count",
     *   summary="SubjectDepartement",
     *   description="SubjectDepartement",
     *   tags={"SubjectDepartement"},
     * @OA\RequestBody(
