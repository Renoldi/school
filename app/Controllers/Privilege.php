...
class Privilege extends ResourceController
{
    protected $modelName = ModelsPrivilege::class;
    protected $format    = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/Privilege/paging/{status}/{perpage}/{page}",
     *   summary="Privilege",
     ...
     *      @OA\JsonContent(ref="#/components/schemas/Privilege")
     *   ),
     *   @OA\Response(
     ...
     *      @OA\Schema(ref="#/components/schemas/Privilege"),
     *     )
     *   ),
     *   @OA\Response(
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesPrivilege();
