...
class Rank extends ResourceController
{
    protected $modelName = ModelsRank::class;
    protected $format    = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/Rank/paging/{status}/{perpage}/{page}",
     *   summary="Rank",
     *   description="Rank",
     *   tags={"Rank"},
     *   @OA\Parameter(
     ...
     *      @OA\Schema(ref="#/components/schemas/Rank"),
     *     )
     *   ),
     *   @OA\Response(
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesRank();
