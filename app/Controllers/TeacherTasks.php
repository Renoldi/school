...
use App\Entities\TeacherTasks as EntitiesTeacherTasks;
use OpenApi\Annotations as OA;
use App\Libraries\StdobjeToArray;
use App\Models\TeacherTasks as ModelsTeacherTasks;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class TeacherTasks extends ResourceController
{
    protected $modelName = ModelsTeacherTasks::class;
     ...
     *   @OA\JsonContent(
     *   type="array",
     *    @OA\Items(ref="#/components/schemas/TeacherTasks")
     *   ),
     *  ),
     *  @OA\Response(
     *   response=400, description="Bad Request"
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesTeacherTasks();
        ...
        foreach ($data as $x => $row) {
            ...
            $subjectEntity->taskId  = trim($row[1]);
            $subjectEntity->tmtTask  = trim($row[2]);
