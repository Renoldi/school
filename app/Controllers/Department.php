...
{
    protected $modelName = ModelsDepartment::class;
    protected $format    = 'json';
    use ResponseTrait;

    /**
     * @OA\Get(
     *   path="/api/Department/paging/{status}/{perpage}/{page}",
     *   summary="Department",
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesDepartment();
