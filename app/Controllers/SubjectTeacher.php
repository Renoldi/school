...
use App\Entities\SubjectTeacher as EntitiesSubjectTeacher;
...
class SubjectTeacher extends ResourceController
{
    protected $modelName = ModelsSubjectTeacher::class;
    protected $format  = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/SubjectTeacher/paging/{perpage}/{page}",
     *   summary="SubjectTeacher",
     *   description="SubjectTeacher",
     *   tags={"SubjectTeacher"},
     *   @OA\Parameter(
     *         name="perpage",
     *         in="path",
     ...
     *      @OA\JsonContent(ref="#/components/schemas/SubjectTeacher")
     *   ),
     *   @OA\Response(
     ...
     *@OA\JsonContent(
     *type="array",
     * @OA\Items(ref="#/components/schemas/SubjectTeacher")
     *),
     *  ),
     *  @OA\Response(
     *response=400, description="Bad Request"
     ...
     *@OA\Schema(ref="#/components/schemas/SubjectTeacher"),
     *)
     *  ),
     *  @OA\Response(
    ...
    public function create()
    {
        ...
        $entity = new EntitiesSubjectTeacher();
    ...
    /**
     * @OA\Post(
     *  path="/api/SubjectTeacher/fromFile",
     *  summary="SubjectTeacher",
     *  description="SubjectTeacher",
     *  tags={"SubjectTeacher"},
     *  @OA\RequestBody(
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesSubjectTeacher();
