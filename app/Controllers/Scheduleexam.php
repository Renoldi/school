...
use App\Entities\Scheduleexam as EntitiesScheduleexam;
use OpenApi\Annotations as OA;
use App\Libraries\StdobjeToArray;
use App\Models\Scheduleexam as ModelsScheduleexam;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class Scheduleexam extends ResourceController
{
    protected $modelName = ModelsScheduleexam::class;
    protected $format    = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/Scheduleexam/paging/{status}/{perpage}/{page}",
     *   summary="Scheduleexam",
     *   description="Scheduleexam",
     *   tags={"Scheduleexam"},
     *   @OA\Parameter(
     *         name="status",
     *         in="path",
     ...
     *      @OA\JsonContent(ref="#/components/schemas/Scheduleexam")
     *   ),
     *   @OA\Response(
     ...
     public function paging($status = 1, $perpage = 20, $page = 1)
    {
        $model = $this->model;
        if ($status != 0) {
            $model = $this->model->where(['scheduleexams.statusId' => $status]);
        }  
     ...
     *     @OA\JsonContent(
     *      type="array",
     *       @OA\Items(ref="#/components/schemas/Scheduleexam")
     *     ),
     *   ),
     *   @OA\Response(
     *     response=400, description="Bad Request"
     ...
     *      @OA\Schema(ref="#/components/schemas/Scheduleexam"),
     *     )
     *   ),
     *   @OA\Response(
    ...
    public function create()
    {
        ...
        $entity = new EntitiesScheduleexam();
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesScheduleexam();
