...
use App\Entities\TeacherTask as EntitiesTeacherTask;
use OpenApi\Annotations as OA;
use App\Libraries\StdobjeToArray;
use App\Models\TeacherTask as ModelsTeacherTask;
use CodeIgniter\API\ResponseTrait;
use CodeIgniter\RESTful\ResourceController;

class TeacherTask extends ResourceController
{
    protected $modelName = ModelsTeacherTask::class;
    protected $format  = 'json';
    use ResponseTrait;
    /**
     * @OA\Get(
     *   path="/api/TeacherTask/paging/{perpage}/{page}",
     *   summary="TeacherTask",
     *   description="TeacherTask",
     *   tags={"TeacherTask"},
     *   @OA\Parameter(
     *         name="perpage",
     *         in="path",
     ...
     *      @OA\JsonContent(ref="#/components/schemas/TeacherTask")
     *   ),
     *   @OA\Response(
    ...
    public function paging($perpage = 20, $page = 1)
    {
        ...
        $data = $model
            ->select('teachertask.id,t.id teacherId, t.name,ta.id taskId, ta.name taskName, teachertask.duration')
            ->join('teachers t', 't.id = teachertask.teacherId')
            ->join('tasks ta', 'ta.id = teachertask.taskId')
            ->orderBy('t.id')
     ...
     *   @OA\JsonContent(
     *   type="array",
     *    @OA\Items(ref="#/components/schemas/TeacherTask")
     *   ),
     *  ),
     *  @OA\Response(
     *   response=400, description="Bad Request"
     ...
     *   @OA\Schema(ref="#/components/schemas/TeacherTask"),
     *   )
     *  ),
     *  @OA\Response(
    ...
    public function create()
    {
        ...
        $entity = new EntitiesTeacherTask();
    ...
    public function  fromFile()
    {
        ...
        $subjectEntity = new EntitiesTeacherTask();
