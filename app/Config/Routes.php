...
$routes->group('api', ['filter' => 'Auth'], function ($routes) {
    ...
    $routes->resource('Students', ['filter' => ['Auth', 'Role:superadmin,admin,editor'], 'except' => 'delete,new']);
    ...
    // $routes->resource('Privileges', ['filter' => ['Auth', 'Role:superadmin,admin,editor'], 'except' => 'delete,new']);
    ...
    $routes->resource('Teachers', ['filter' => ['Auth', 'Role:superadmin,admin,editor'], 'except' => 'index,delete,new']);
